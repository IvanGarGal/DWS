...
public class MandarMail {
    ...
    public void mandarMail(String to, String cod_act) {
        try {
            ...
            email.setFrom("tiendaonlinemiguel@gmail.com");
            email.setSubject("Activación de cuenta");
            email.setHtmlMsg("<body><html><h2>Activar cuenta</h2><a href=\"http://localhost:8080/loginMiguel/login?action=activar&cod_act="+cod_act+"\">Activar</a></body></html>");
            email.addTo(to);    
            email.send();
