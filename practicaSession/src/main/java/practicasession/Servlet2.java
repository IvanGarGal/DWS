...
public class Servlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute(Constantes.ATTRIBUTE_NAME) != null) {
            //1ºnivel
            if (request.getSession().getAttribute(Constantes.ATTRIBUTE_NAME).equals("1")) {
            ...
            //2ºnivel
            if (request.getSession().getAttribute(Constantes.ATTRIBUTE_NAME).equals("2.1")) {
            ...
            //3ºnivel
            if (request.getSession().getAttribute(Constantes.ATTRIBUTE_NAME).equals("2.2")) {
